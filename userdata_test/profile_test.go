...
const (
	defaultProfileJson  string = `{"name":"Trader J","keystore":false}`
	errmsgProfileExists string = "profile already exists"
)

var defaultProfile userdata.Profile = userdata.Profile{Name: "Trader J", Keystore: false}

// TODO: Need to make bkup - test - restore.
func TestInitialiseProfile(t *testing.T) {
	profileConditions := ProfileConditions("TestInitialiseProfile", t)
	...
	// TODO: Will need to revise this check as profile evolves.

	fmt.Println(defaultProfile)
	fmt.Println(testProfile)
